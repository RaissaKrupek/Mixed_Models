...
rm(list=ls()) 
setwd("C:/Users/sgeza/OneDrive/Desktop/Workshops ASReml-R/ASReml_ESALQ/Material/Session09")
library(ASRgenomics)
...
G_bend <- G.tuneup(G=G, bend=TRUE, eig.tol = 1e-06)$Gb
...
# Plotting G_blend Matrix
kinship.heatmap(G_blend)

# Saving Matrices
save(G_blend, Ginv.blend, file = "../Gmat.RData")
